...
export const enDict = {
  ...
  snapshotOnly: 'Static snapshot: the bundled dataset currently mixes 2025 Q4 for most institutions and 2025 Q3 for TCI.',
  mixedSnapshotNotice: 'Non-uniform filing snapshot: 11 institutions are on 2025 Q4, while TCI remains on 2025 Q3.',
...
export const zhDict: TranslationDict = {
  ...
  snapshotOnly: '静态快照：当前打包数据中，大多数机构为 2025 Q4，TCI 仍为 2025 Q3。',
  mixedSnapshotNotice: '非统一披露快照：11 家机构是 2025 Q4，TCI 仍是 2025 Q3。',
  snapshotLabel: '已打包快照',
